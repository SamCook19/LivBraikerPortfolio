    ...
    class DigitalEdit extends Component {
        constructor(props) {
            super(props);
        ...
        uploadImageCallBack = (e) => {
            return new Promise(async(resolve, reject) => {
                ...
                storageRef.ref().child("Digital/" + fileName).put(file)
                .then( async snapshot => {
                    
                    const downloadURL = await storageRef.ref().child("Digital/" +fileName).getDownloadURL()
